...
class transceiver_CSS_USRP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "transceiver_CSS_USRP")
        ...
        self.uhd_usrp_sink_1.set_normalized_gain(tx_gain, 0)
    ...
    def set_tx_gain(self, tx_gain):
        ...
        self.uhd_usrp_sink_1.set_normalized_gain(self.tx_gain, 0)
